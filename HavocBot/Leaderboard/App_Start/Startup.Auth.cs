...
namespace Leaderboard
{
    public partial class Startup
    {
        ...
        private async Task OnAuthorization(AuthorizationCodeReceivedNotification context)
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"Failed to acquire token: {e.Message}");
            }
        }
        ...
        private Task OnAuthenticationFailed(
            AuthenticationFailedNotification<Microsoft.IdentityModel.Protocols.OpenIdConnect.OpenIdConnectMessage,
